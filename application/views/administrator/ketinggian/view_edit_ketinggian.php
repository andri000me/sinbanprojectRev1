<div class="row">
	...
	<div class="span8">
		<?php echo form_open_multipart(site_url('administrator/ketinggian_air/edit/'.$tampilketinggian->id_ketinggian)); ?>
	        <fieldset>
	            ...
	            <div class="input-control text" data-role="input-control">
	                <input type="text" placeholder="Masukan Ketinggian Air Dalam CM" name="ketinggian_air" value="<?php echo $tampilketinggian->ketinggian_air; ?>">
	            ...
	            <label>Radius</label>
	            <div class="input-control text" data-role="input-control">
	                <input type="text" placeholder="Masukan Radius Daerah Genangan dalam Meter" name="radius_daerah" value="<?php echo $tampilketinggian->radius_daerah; ?>">
	            </div>
	            <br><br>
