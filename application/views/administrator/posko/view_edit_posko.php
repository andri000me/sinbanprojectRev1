<div class="row">
	...
	<div class="span8">
		<?php echo form_open_multipart(site_url('administrator/posko/edit/'.$tampilposko->id_posko)); ?>
	        <fieldset>
	            <legend>FORM EDIT DATA POSKO</legend>
	            <?php if (! empty($pesan)) : ?>
			        <p class="fg-red">
			            <?php echo $pesan; ?>
			        </p>
	            ...
	            <div class="input-control text" data-role="input-control">
	                <input type="text" placeholder="Masukan Nama Posko" name="nama_posko" value="<?php echo $tampilposko->nama_posko; ?>">
	            ...
	            <div class="input-control text" data-role="input-control">
	                <textarea placeholder="Masukan Alamat Lengkap Posko (Maks. 50 Karakter)" name="alamat_posko" cols="50%" rows="3px"><?php echo $tampilposko->alamat_posko; ?></textarea>
	            </div>
	            <br><br>
